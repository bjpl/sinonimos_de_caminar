...
/**
 * Unsplash Image Downloader for Sinónimos de Caminar
 *
 * Downloads curated images for the walking synonyms application
...
// Configuration
const CONFIG = {
  UNSPLASH_ACCESS_KEY: process.env.UNSPLASH_ACCESS_KEY || 'YOUR_UNSPLASH_ACCESS_KEY_HERE',
...
const IMAGE_QUERIES = {
  ...
  trajinar: {
    query: 'busy person walking market street bustling',
    category: 'synonym',
...
const main = async () => {
  console.log('\n' + '='.repeat(60));
  console.log('UNSPLASH IMAGE DOWNLOADER - Sinónimos de Caminar');
  console.log('='.repeat(60) + '\n');
